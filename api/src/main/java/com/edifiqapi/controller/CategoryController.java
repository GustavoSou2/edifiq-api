...
public class CategoryController {
    ...
    @GetMapping("/{id}")
    public CategoryResponse get(@AuthenticationPrincipal Jwt jwt, @PathVariable String id) {
        String tenantId = JwtClaims.tenantId(jwt);
    ...
    @PutMapping("/{id}")
    public CategoryResponse update(@AuthenticationPrincipal Jwt jwt, @PathVariable String id, @Valid @RequestBody UpsertCategoryRequest request) {
        String tenantId = JwtClaims.tenantId(jwt);
